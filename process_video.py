...
def main():
    ...
    parser.add_argument('--out_video', type=str, default='output_fast.mp4', help='Path to output video')
    parser.add_argument('--checkpoint', type=str, default=DEFAULT_CHECKPOINT, help='Path to pretrained model checkpoint')
    parser.add_argument('--rescale_factor', type=float, default=2.0, help='Factor for padding the bbox')
    parser.add_argument('--body_detector', type=str, default='regnety', choices=['vitdet', 'regnety'])
    parser.add_argument('--max_seconds', type=int, default=0, help='Max seconds of video to process')
    parser.add_argument('--det_stride', type=int, default=5, help='Run body detector every N frames for speed')
    parser.add_argument('--scale_inference', type=float, default=0.5, help='Downscale frame for detector inference for speed (e.g. 0.5 for 540p, 0.67 for 720p)')
